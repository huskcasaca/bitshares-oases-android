package com.bitshares.android.ui.account.keychain
...
import com.bitshares.android.chain.BrainKeyDict
import com.bitshares.android.chain.blockchainDatabaseScope
import com.bitshares.android.extensions.viewbinder.bindPrivateKey
            ...
            viewModel.user.observe(viewLifecycleOwner) {
                doOnClick {
                    blockchainDatabaseScope.launch {
                        if (it != null) LocalUserRepository.removeKey(it, key, type)
                    }
                }
            }
        }
