package com.bitshares.android.ui.transaction
...
import com.bitshares.android.chain.operationNameStringResMap
import com.bitshares.android.extensions.compat.startBlockBrowser
...
fun BottomDialogFragment.bindTransaction(builder: TransactionBuilder, accountViewModel: AccountViewModel) {
    ...
    button {
        ...
        combineNonNull(accountViewModel.accountUid, isAuthorized, SecurityService.isUnlocked).observe(viewLifecycleOwner) { (uid, isAuthorized, isUnlocked) ->
