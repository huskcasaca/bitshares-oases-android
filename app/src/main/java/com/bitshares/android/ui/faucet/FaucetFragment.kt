package com.bitshares.android.ui.faucet
...
import com.bitshares.android.chain.blockchainNetworkScope
...
import com.bitshares.android.netowrk.faucets.*
                                ...
                                lifecycleScope.launch {
                                    if (startWalletUnlock()) {
                                        blockchainNetworkScope.launch network@{
                                            ...
                                            blockchainDatabaseScope.launch { LocalUserRepository.add(user) }
                                        }
                                        finish()
                                        dismiss()
                                        activity
