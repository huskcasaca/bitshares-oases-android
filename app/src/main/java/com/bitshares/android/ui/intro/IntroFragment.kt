package com.bitshares.android.ui.intro
...
import com.bitshares.android.extensions.compat.startImport
...
import com.bitshares.android.ui.account.importer.ImportViewModel
import com.bitshares.android.ui.base.ContainerFragment
import com.bitshares.android.ui.base.*
import com.bitshares.android.ui.faucet.FaucetViewModel
import com.bitshares.android.ui.faucet.showFaucetRegisterDialog
import com.bitshares.android.ui.faucet.showFaucetSelectDialog
import com.bitshares.android.ui.settings.showLanguageSettingDialog
import com.bitshares.android.ui.wallet.startWalletUnlock
...
fun Union.showLoginDialog() = showBottomDialog {
    ...
    section {
        ...
        cell {
            updatePaddingVerticalV6()
                title = context.getString(com.bitshares.android.R.string.import_password)
                field {
                ...
                viewModel.checkingState.observe(viewLifecycleOwner) { state ->
                    ...
                    subtitle = when (state) {
                        ...
                        ImportViewModel.State.INVALID_SECRET -> context.getString(com.bitshares.android.R.string.import_invalid_password)
                        ImportViewModel.State.COMPLETE -> EMPTY_SPACE
                    }
                }
                viewModel.cloudPermissions.observe(viewLifecycleOwner) {
                    if (viewModel.checkingState.value == com.bitshares.android.ui.account.importer.ImportViewModel.State.COMPLETE) {
