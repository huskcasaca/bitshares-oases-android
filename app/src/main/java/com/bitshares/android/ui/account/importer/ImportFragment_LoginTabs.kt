...
import com.bitshares.android.ui.account.importer.ImportViewModel.State
import com.bitshares.android.ui.base.ContainerFragment
import com.bitshares.android.ui.base.*
import com.bitshares.android.ui.wallet.startWalletRestore
                            ...
                            viewModel.cloudPermissions.observe(viewLifecycleOwner) {
                                if (viewModel.checkingState.value == com.bitshares.android.ui.account.importer.ImportViewModel.State.COMPLETE) {
                                    subtitle = buildContextSpannedString {
                                        if (it.contains(Authority.OWNER)) appendTag(context.getString(com.bitshares.android.R.string.tag_owner).uppercase(), context.getColor(R.color.tag_default), context.getColor(R.color.cell_text_secondary))
