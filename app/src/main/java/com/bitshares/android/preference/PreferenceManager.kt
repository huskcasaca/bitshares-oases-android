...
class PreferenceManager(
    private val application: ModulonApplication
    ...
    val KEY_USE_PASSWORD = livePreferenceInternal("pref_use_password", false)
    val KEY_USE_FINGERPRINT = livePreferenceInternal("pref_use_fingerprint", false)
