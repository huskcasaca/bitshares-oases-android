...
inline fun ViewGroup.addDefault(view: View, width: Int = WRAP_CONTENT, height: Int = WRAP_CONTENT, block: ViewGroup.LayoutParams.() -> Unit = {}) = addViewWithParams(view, viewParams(width, height).apply(block))
inline fun ViewGroup.addDefaultRow(view: View, width: Int = MATCH_PARENT, height: Int = WRAP_CONTENT, block: ViewGroup.LayoutParams.() -> Unit = {}) = addViewWithParams(view, viewParams(width, height).apply(block))
inline fun ViewGroup.addDefaultFill(view: View, width: Int = MATCH_PARENT, height: Int = MATCH_PARENT, block: ViewGroup.LayoutParams.() -> Unit = {}) = addViewWithParams(view, viewParams(width, height).apply(block))

@OptIn(ExperimentalContracts::class)
inline fun <T: View> ViewGroup.view(view: T, block: T.() -> Unit = {}) {
    contract { callsInPlace(block, InvocationKind.EXACTLY_ONCE) }
    addView(view.apply(block))
}

@OptIn(ExperimentalContracts::class)
inline fun <T: View> ViewGroup.viewRow(view: T, block: T.() -> Unit = {}) {
    contract { callsInPlace(block, InvocationKind.EXACTLY_ONCE) }
    view.apply {
...
var View.layoutGravity: Int
    get() = TODO()
    set(value) {
        layoutParams = // TODO should remove value assigning?
            layoutParams.apply {
            when (this) {
