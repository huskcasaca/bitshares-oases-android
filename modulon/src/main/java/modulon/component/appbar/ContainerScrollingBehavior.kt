...
import modulon.layout.coordinator.behavior.HeaderScrollingBehavior

class ContainerScrollingBehavior() : HeaderScrollingBehavior() {

    override fun layoutDependsOn(parent: CoordinatorLayout, child: View, dependency: View): Boolean {
        return dependency is AppbarView
    }

    override fun onDependentViewChanged(parent: CoordinatorLayout, child: View, dependency: View): Boolean {
        val new = (dependency as AppbarView).translationY
...
//        }
    ...
    override fun findFirstDependency(views: List<View>): View? {
        return views.firstOrNull { it is AppbarView }
    }

    override fun getScrollRange(v: View): Int {
        return if (v is AppbarView) 64.dp else super.getScrollRange(v)
    }
