...
data class K103_AssetObject(
    ...
    @SerialName(KEY_ISSUER) @Serializable(with = ObjectIdTypeSerializer::class) override val issuerId: K102_AccountType = emptyIdType(),
    ...
    @SerialName(KEY_DYNAMIC_ASSET_DATA_ID) @Serializable(with = ObjectIdTypeSerializer::class) override val dynamicDataId: K203_AssetDynamicType = emptyIdType(),
