...
data class AccountOptions(
    @SerialName(KEY_MEMO_KEY) val memoKey: PublicKeyType = PublicKeyType.EMPTY,
    @SerialName(KEY_VOTING_ACCOUNT) @Serializable(with = ObjectIdTypeSerializer::class) @Suppress("SERIALIZER_TYPE_INCOMPATIBLE") val votingAccount: K102_AccountIdType = emptyIdType(),
