...
data class LinearVestingPolicyInitializer(
    ...
    @SerialName("vesting_cliff_seconds") val vestingCliffSeconds: uint32_t, // = 0
    @SerialName("vesting_duration_seconds") val vestingDurationSeconds: uint32_t, // = 0
...
data class CddVestingPolicyInitializer(
    ...
    @SerialName("vesting_seconds") val vestingSeconds: uint32_t, // = 0
) : VestingPolicyInitializer()
