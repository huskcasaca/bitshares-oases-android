...
//        periods_until_expiration: uint32
        ...
        fun fromJson(rawJson: JSONObject, rawJsonResult: JSONArray = JSONArray()): WithdrawPermissionClaimOperation {
            return WithdrawPermissionClaimOperation(
    ...
    override val operationType = OperationType.WITHDRAW_PERMISSION_CLAIM_OPERATION
